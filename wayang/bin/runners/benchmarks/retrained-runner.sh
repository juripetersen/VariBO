...
bvae_path=/work/lsbo-paper/data/models/retrained/bvae.onnx
...
for query in ${queries[@]}; do
    for i in {0..5}; do
        ./bin/wayang-submit -Xmx32g org.apache.wayang.ml.benchmarks.TPCHBenchmarks java,spark,flink,giraph $data_path $data_path/benchmarks/retrained/ $query bvae $bvae_path $experience_path
    done
done
