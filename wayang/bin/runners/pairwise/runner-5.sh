...
for i in {5001..6000}; do
    ./bin/wayang-submit -Xmx32g org.apache.wayang.ml.training.Encode java,spark,flink,giraph file:///work/thesis/data/ /work/thesis/data/pairwise-encodings-5.txt $i
done
