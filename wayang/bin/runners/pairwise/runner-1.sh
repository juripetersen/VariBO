...
for i in {1001..2000}; do
    ./bin/wayang-submit -Xmx32g org.apache.wayang.ml.training.Encode java,spark,flink,giraph file:///work/thesis/data/ /work/thesis/data/pairwise-encodings-1.txt $i
done
