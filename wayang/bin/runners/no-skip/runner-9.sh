...
for i in {9001..10000}; do
    ./bin/wayang-submit -Xmx32g org.apache.wayang.ml.training.Training java,spark,flink,giraph file:///work/thesis/data/ /work/thesis/data/encodings-9.txt $i
done
