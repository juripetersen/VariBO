...
for i in {8001..9000}; do
    ./bin/wayang-submit -Xmx32g org.apache.wayang.ml.training.Training java,spark,flink,giraph file:///work/thesis/data/ /work/thesis/data/encodings-8.txt $i
done
