...
for i in {6001..7000}; do
    ./bin/wayang-submit -Xmx32g org.apache.wayang.ml.training.Training java,spark,flink,giraph file:///work/thesis/data/ /work/thesis/data/encodings-6.txt $i
done
