...
public class GenericJdbcProjectionOperator extends JdbcProjectionOperator implements GenericJdbcExecutionOperator {
    ...
    public GenericJdbcProjectionOperator(MapOperator<Record, Record> that) {
        super(that);
    }

    @Override
    protected GenericJdbcProjectionOperator createCopy() {
        return new GenericJdbcProjectionOperator(this);
    }
