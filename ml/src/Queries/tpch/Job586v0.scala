 ...
 */
 ...
 class Job586v0 extends GeneratableJob {
...
val group5 = map4.reduceByKey(_._1, (t1,t2) => t1)
...
val group7 = map9.reduceByKey(_._3, (t1,t2) => t1)
          

val join6 = group5.keyBy[Long](_._2).join(group7.keyBy[Long](_._1)).map(x => x.field1)
