 ...
 */
 ...
 class Job600v0 extends GeneratableJob {
...
val filter9 = join6.filter(x=>x._4 == 6.0)
...
val filter11 = map12.filter(x=>x._3 == 1.0)
      

val join10 = filter9.keyBy[Long](_._4).join(filter11.keyBy[Long](_._1)).map(x => x.field1)
