 ...
 */
 ...
 class Job886v0 extends GeneratableJob {
...
val group3 = map2.reduceByKey(_._1, (t1,t2) => t1)
          

val map4 = group3.map(x=> {var count = 0; for (v <- x.productIterator) count+=1; x})
