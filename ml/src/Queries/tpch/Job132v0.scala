 ...
 */
 ...
 class Job132v0 extends GeneratableJob {
...
val join13 = reduce12.keyBy[Long](_._4).join(source14.keyBy[Long](_._1)).map(x => x.field1)
       

val map15 = join13.map(x=>x).withUdfComplexity(UDFComplexity.LINEAR)
