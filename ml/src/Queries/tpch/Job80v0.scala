 ...
 */
 ...
 class Job80v0 extends GeneratableJob {
...
val group9 = group10.reduceByKey(_._3, (t1,t2) => t1)
...
val join14 = reduce13.keyBy[Long](_._4).join(filter15.keyBy[Long](_._1)).map(x => x.field1)
