 ...
 */
 ...
 class Job868v0 extends GeneratableJob {
...
val filter10 = source11.filter(x=>x._3 == 3.0)
      

val join9 = join6.keyBy[Long](_._4).join(filter10.keyBy[Long](_._1)).map(x => x.field1)
