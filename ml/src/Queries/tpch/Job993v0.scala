 ...
 */
 ...
 class Job993v0 extends GeneratableJob {
...
val filter2 = filter3.filter(x=>x._3 <= 7499.0)
...
val join5 = join1.keyBy[Long](_._2).join(map6.keyBy[Long](_._1)).map(x => x.field1)
       

val group11 = join5.reduceByKey(_._3, (t1,t2) => t1)
          

val group12 = group11.reduceByKey(_._3, (t1,t2) => t1)
