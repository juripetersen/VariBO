 ...
 */
 ...
 class Job859v0 extends GeneratableJob {
...
val group8 = group9.reduceByKey(_._3, (t1,t2) => t1)
          

val join7 = join2.keyBy[Long](_._2).join(group8.keyBy[Long](_._1)).map(x => x.field1)
       

val filter12 = join7.filter(x=>x._6 <= 4541.0650000000005)
...
val join13 = filter12.keyBy[Long](_._4).join(source14.keyBy[Long](_._1)).map(x => x.field1)
       

val reduce15 = join13.reduce((x1, x2) => x1)
