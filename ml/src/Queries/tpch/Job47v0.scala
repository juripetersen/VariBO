 ...
 */
 ...
 class Job47v0 extends GeneratableJob {
...
val sort2 = filter1.sort(_._6)
      

val group3 = sort2.reduceByKey(_._14, (t1,t2) => t1)
...
val join4 = group3.keyBy[Long](_._2).join(map5.keyBy[Long](_._1)).map(x => x.field1)
       

val map9 = join4.map(x=>x).withUdfComplexity(UDFComplexity.LINEAR)
