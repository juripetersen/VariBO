 ...
 */
 ...
 class Job484v0 extends GeneratableJob {
...
val group6 = source7.reduceByKey(_._1, (t1,t2) => t1)
...
val filter11 = group12.filter(x=>x._6 <= 4541.0650000000005)
      

val join10 = map9.keyBy[Long](_._2).join(filter11.keyBy[Long](_._1)).map(x => x.field1)
