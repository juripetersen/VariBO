 ...
 */
 ...
 class Job829v0 extends GeneratableJob {
...
val filter3 = map4.filter(x=>x._4 <= 250.81)
...
val filter9 = source10.filter(x=>x._6 <= 7270.635)
      

val join8 = map7.keyBy[Long](_._2).join(filter9.keyBy[Long](_._1)).map(x => x.field1)
       

val reduce11 = join8.reduce((x1, x2) => x1)
...
val reduce13 = map15.reduce((x1, x2) => x1)
      

val join12 = reduce11.keyBy[Long](_._4).join(reduce13.keyBy[Long](_._1)).map(x => x.field1)
