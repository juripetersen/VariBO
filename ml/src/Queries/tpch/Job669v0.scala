 ...
 */
 ...
 class Job669v0 extends GeneratableJob {
...
val join3 = map2.keyBy[Long](_._2).join(source4.keyBy[Long](_._1)).map(x => x.field1)
...
val join5 = join3.keyBy[Long](_._2).join(group6.keyBy[Long](_._1)).map(x => x.field1)
