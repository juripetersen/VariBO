 ...
 */
 ...
 class Job704v0 extends GeneratableJob {
...
val map7 = group6.map(x=> {var count = 0; for (v1 <- x.productIterator; v2 <- x.productIterator) count+=1; x})
...
val reduce13 = join8.reduce((x1, x2) => x1)
