 ...
 */
 ...
 class Job776v0 extends GeneratableJob {
...
val filter8 = source9.filter(x=>x._4 <= 250.81)
...
val join5 = map4.keyBy[Long](_._2).join(reduce6.keyBy[Long](_._1)).map(x => x.field1)
