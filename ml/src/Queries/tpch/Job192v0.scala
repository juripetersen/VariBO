 ...
 */
 ...
 class Job192v0 extends GeneratableJob {
...
val filter7 = source8.filter(x=>x._6 <= 4541.0650000000005)
...
val join10 = group9.keyBy[Long](_._4).join(reduce11.keyBy[Long](_._1)).map(x => x.field1)
