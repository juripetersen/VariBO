 ...
 */
 ...
 class Job757v0 extends GeneratableJob {
...
val group5 = map4.reduceByKey(_._2, (t1,t2) => t1)
...
val map7 = group8.map(x=> {var count = 0; for (v1 <- x.productIterator; v2 <- x.productIterator) count+=1; x})
                  .withUdfComplexity(UDFComplexity.SUPERQUADRATIC)
