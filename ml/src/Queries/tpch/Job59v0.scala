 ...
 */
 ...
 class Job59v0 extends GeneratableJob {
...
val map5 = group4.map(x=> {var count = 0; for (v1 <- x.productIterator; v2 <- x.productIterator) count+=1; x})
...
val group8 = source10.reduceByKey(_._1, (t1,t2) => t1)
