 ...
 */
 ...
 class Job221v0 extends GeneratableJob {
...
val join3 = reduce2.keyBy[Long](_._2).join(reduce4.keyBy[Long](_._1)).map(x => x.field1)
...
val join10 = group9.keyBy[Long](_._2).join(map11.keyBy[Long](_._1)).map(x => x.field1)
