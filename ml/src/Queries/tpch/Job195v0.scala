 ...
 */
 ...
 class Job195v0 extends GeneratableJob {
...
val filter6 = source7.filter(x=>x._3 <= 7499.0)
...
val join3 = group2.keyBy[Long](_._2).join(map4.keyBy[Long](_._1)).map(x => x.field1)
...
val filter11 = source12.filter(x=>x._4 == 6.0)
      

val join10 = reduce9.keyBy[Long](_._2).join(filter11.keyBy[Long](_._1)).map(x => x.field1)
