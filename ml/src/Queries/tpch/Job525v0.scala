 ...
 */
 ...
 class Job525v0 extends GeneratableJob {
...
val sort5 = source6.sort(_._3)
      

val group4 = sort5.reduceByKey(_._1, (t1,t2) => t1)
...
val map11 = group12.map(x=> {var count = 0; for (v <- x.productIterator) count+=1; x})
                  .withUdfComplexity(UDFComplexity.QUADRATIC)
