 ...
 */
 ...
 class Job702v0 extends GeneratableJob {
...
val reduce6 = join2.reduce((x1, x2) => x1)
...
val reduce10 = source11.reduce((x1, x2) => x1)
      

val sort9 = reduce10.sort(_._3)
      

val filter8 = sort9.filter(x=>x._6 <= 7270.635)
      

val join7 = reduce6.keyBy[Long](_._2).join(filter8.keyBy[Long](_._1)).map(x => x.field1)
