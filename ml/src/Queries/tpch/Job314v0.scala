 ...
 */
 ...
 class Job314v0 extends GeneratableJob {
...
val filter11 = map12.filter(x=>x._6 <= 4541.0650000000005)
...
val join14 = join9.keyBy[Long](_._4).join(filter15.keyBy[Long](_._1)).map(x => x.field1)
