 ...
 */
 ...
 class Job253v0 extends GeneratableJob {
...
val group6 = map4.reduceByKey(_._1, (t1,t2) => t1)
          

val group7 = group6.reduceByKey(_._1, (t1,t2) => t1)
...
val join8 = group7.keyBy[Long](_._2).join(map9.keyBy[Long](_._1)).map(x => x.field1)
       

 return join8.collectNoExecute()
