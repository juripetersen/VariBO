 ...
 */
 ...
 class Job143v0 extends GeneratableJob {
...
val filter6 = join2.filter(x=>x._4 <= 500.41)
...
val sort9 = filter10.sort(_._5)
      

val filter8 = sort9.filter(x=>x._4 == 6.0)
      

val join7 = filter6.keyBy[Long](_._2).join(filter8.keyBy[Long](_._1)).map(x => x.field1)
       

val group13 = join7.reduceByKey(_._3, (t1,t2) => t1)
