 ...
 */
 ...
 class Job290v0 extends GeneratableJob {
...
val join5 = join1.keyBy[Long](_._2).join(source6.keyBy[Long](_._1)).map(x => x.field1)
       

val reduce8 = join5.reduce((x1, x2) => x1)
      

val filter9 = reduce8.filter(x=>x._6 <= 4541.0650000000005)
