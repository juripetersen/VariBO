 ...
 */
 ...
 class Job625v0 extends GeneratableJob {
...
val group5 = source7.reduceByKey(_._3, (t1,t2) => t1)
          

val group4 = group5.reduceByKey(_._3, (t1,t2) => t1)
          

val join3 = join1.keyBy[Long](_._2).join(group4.keyBy[Long](_._1)).map(x => x.field1)
       

val filter8 = join3.filter(x=>x._6 <= 7270.635)
...
val group12 = source13.reduceByKey(_._2, (t1,t2) => t1)
...
val join9 = filter8.keyBy[Long](_._4).join(map10.keyBy[Long](_._1)).map(x => x.field1)
       

val filter14 = join9.filter(x=>x._3 == 2.0)
      

val filter15 = filter14.filter(x=>x._3 == 2.0)
      

 return filter15.collectNoExecute()
