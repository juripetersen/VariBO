 ...
 */
 ...
 class Job851v0 extends GeneratableJob {
...
val group4 = join1.reduceByKey(_._1, (t1,t2) => t1)
...
val group7 = source9.reduceByKey(_._3, (t1,t2) => t1)
          

val group6 = group7.reduceByKey(_._3, (t1,t2) => t1)
          

val join5 = group4.keyBy[Long](_._2).join(group6.keyBy[Long](_._1)).map(x => x.field1)
...
val partition13 = source14.mapPartitions(x=>x)
      

val sort12 = partition13.sort(_._4)
      

val filter11 = sort12.filter(x=>x._3 == 2.0)
      

val join10 = join5.keyBy[Long](_._4).join(filter11.keyBy[Long](_._1)).map(x => x.field1)
...
val group16 = map15.reduceByKey(_._2, (t1,t2) => t1)
