 ...
 */
 ...
 class Job612v0 extends GeneratableJob {
...
val filter14 = reduce15.filter(x=>x._3 == 1.0)
      

val join13 = reduce12.keyBy[Long](_._4).join(filter14.keyBy[Long](_._1)).map(x => x.field1)
