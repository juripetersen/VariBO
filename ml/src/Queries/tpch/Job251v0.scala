 ...
 */
 ...
 class Job251v0 extends GeneratableJob {
...
val group4 = group3.reduceByKey(_._1, (t1,t2) => t1)
...
val group7 = source9.reduceByKey(_._1, (t1,t2) => t1)
          

val map6 = group7.map(x=> {var count = 0; for (v <- x.productIterator) count+=1; x})
