 ...
 */
 ...
 class Job860v0 extends GeneratableJob {
...
val sort4 = partition3.sort(_._4)
      

val map5 = sort4.map(x=> {var count = 0; for (v1 <- x.productIterator; v2 <- x.productIterator) count+=1; x})
