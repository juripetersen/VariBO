 ...
 */
 ...
 class Job786v0 extends GeneratableJob {
...
val sort10 = partition11.sort(_._2)
      

val group9 = sort10.reduceByKey(_._3, (t1,t2) => t1)
          

val join8 = group7.keyBy[Long](_._2).join(group9.keyBy[Long](_._1)).map(x => x.field1)
