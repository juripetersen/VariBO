 ...
 */
 ...
 class Job375v0 extends GeneratableJob {
...
val filter3 = join1.filter(x=>x._3 <= 5003.0)
...
val sort7 = source8.sort(_._3)
      

val group6 = sort7.reduceByKey(_._3, (t1,t2) => t1)
          

val filter5 = group6.filter(x=>x._4 == 6.0)
...
val join9 = join4.keyBy[Long](_._4).join(source10.keyBy[Long](_._1)).map(x => x.field1)
