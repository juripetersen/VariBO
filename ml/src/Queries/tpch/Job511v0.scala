 ...
 */
 ...
 class Job511v0 extends GeneratableJob {
...
val filter3 = map4.filter(x=>x._3 <= 7499.0)
      

val map2 = filter3.map(x=> {var count = 0; for (v <- x.productIterator) count+=1; x})
...
val group9 = map7.reduceByKey(_._1, (t1,t2) => t1)
