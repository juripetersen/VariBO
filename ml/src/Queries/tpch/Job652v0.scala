 ...
 */
 ...
 class Job652v0 extends GeneratableJob {
...
val reduce4 = map5.reduce((x1, x2) => x1)
      

val join3 = map2.keyBy[Long](_._2).join(reduce4.keyBy[Long](_._1)).map(x => x.field1)
...
val join8 = join3.keyBy[Long](_._2).join(filter9.keyBy[Long](_._1)).map(x => x.field1)
...
val join12 = group11.keyBy[Long](_._4).join(source13.keyBy[Long](_._1)).map(x => x.field1)
