 ...
 */
 ...
 class Job278v0 extends GeneratableJob {
...
val filter8 = source9.filter(x=>x._4 == 12.0)
      

val map7 = filter8.map(x=>x).withUdfComplexity(UDFComplexity.LINEAR)
...
val reduce13 = map11.reduce((x1, x2) => x1)
