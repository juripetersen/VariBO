 ...
 */
 ...
 class Job366v0 extends GeneratableJob {
...
val join9 = reduce8.keyBy[Long](_._2).join(filter10.keyBy[Long](_._1)).map(x => x.field1)
...
val sort14 = map15.sort(_._4)
      

val group13 = sort14.reduceByKey(_._2, (t1,t2) => t1)
          

val join12 = join9.keyBy[Long](_._4).join(group13.keyBy[Long](_._1)).map(x => x.field1)
