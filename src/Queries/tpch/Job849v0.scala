 ...
 */
 ...
 class Job849v0 extends GeneratableJob {
...
val reduce6 = map7.reduce((x1, x2) => x1)
      

val filter5 = reduce6.filter(x=>x._3 <= 7499.0)
...
val reduce10 = map11.reduce((x1, x2) => x1)
      

val join9 = join4.keyBy[Long](_._2).join(reduce10.keyBy[Long](_._1)).map(x => x.field1)
