 ...
 */
 ...
 class Job244v0 extends GeneratableJob {
...
val join3 = join1.keyBy[Long](_._2).join(source4.keyBy[Long](_._1)).map(x => x.field1)
...
val join5 = join3.keyBy[Long](_._4).join(reduce6.keyBy[Long](_._1)).map(x => x.field1)
...
val group12 = map11.reduceByKey(_._2, (t1,t2) => t1)
