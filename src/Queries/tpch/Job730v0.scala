 ...
 */
 ...
 class Job730v0 extends GeneratableJob {
...
val join9 = join6.keyBy[Long](_._4).join(source10.keyBy[Long](_._1)).map(x => x.field1)
       

val group12 = join9.reduceByKey(_._2, (t1,t2) => t1)
          

val group13 = group12.reduceByKey(_._2, (t1,t2) => t1)
