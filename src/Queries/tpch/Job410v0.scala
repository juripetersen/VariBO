 ...
 */
 ...
 class Job410v0 extends GeneratableJob {
...
val sort5 = reduce4.sort(_._12)
      

val map6 = sort5.map(x=> {var count = 0; for (v1 <- x.productIterator; v2 <- x.productIterator) count+=1; x})
