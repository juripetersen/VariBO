 ...
 */
 ...
 class Job512v0 extends GeneratableJob {
...
val map5 = filter6.map(x=> {var count = 0; for (v <- x.productIterator) count+=1; x})
...
val partition10 = map9.mapPartitions(x=>x)
      

val sort11 = partition10.sort(_._5)
      

 return sort11.collectNoExecute()
