 ...
 */
 ...
 class Job615v0 extends GeneratableJob {
...
val filter2 = map1.filter(x=>x._15 ==  "AIR" )
...
val map7 = join3.map(x=>x).withUdfComplexity(UDFComplexity.LINEAR)
