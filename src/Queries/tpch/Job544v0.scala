 ...
 */
 ...
 class Job544v0 extends GeneratableJob {
...
val filter4 = source5.filter(x=>x._3 <= 7499.0)
...
val partition12 = map11.mapPartitions(x=>x)
      

 return partition12.collectNoExecute()
