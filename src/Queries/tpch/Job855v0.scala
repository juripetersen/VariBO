 ...
 */
 ...
 class Job855v0 extends GeneratableJob {
...
val map5 = join1.map(x=> {var count = 0; for (v1 <- x.productIterator; v2 <- x.productIterator) count+=1; x})
