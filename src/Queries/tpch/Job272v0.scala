 ...
 */
 ...
 class Job272v0 extends GeneratableJob {
...
val group8 = map6.reduceByKey(_._1, (t1,t2) => t1)
          

val group9 = group8.reduceByKey(_._1, (t1,t2) => t1)
          

val map10 = group9.map(x=>x).withUdfComplexity(UDFComplexity.LINEAR)
