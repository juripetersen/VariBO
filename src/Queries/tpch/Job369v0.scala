 ...
 */
 ...
 class Job369v0 extends GeneratableJob {
...
val filter9 = reduce10.filter(x=>x._3 == 1.0)
      

val join8 = join5.keyBy[Long](_._4).join(filter9.keyBy[Long](_._1)).map(x => x.field1)
