 ...
 */
 ...
 class Job635v0 extends GeneratableJob {
...
val filter9 = group8.filter(x=>x._3 <= 5003.0)
...
val join10 = filter9.keyBy[Long](_._2).join(source11.keyBy[Long](_._1)).map(x => x.field1)
