 ...
 */
 ...
 class Job536v0 extends GeneratableJob {
...
val partition6 = source7.mapPartitions(x=>x)
      

val sort5 = partition6.sort(_._2)
      

val filter4 = sort5.filter(x=>x._3 <= 5003.0)
...
val filter10 = reduce11.filter(x=>x._6 <= 7270.635)
