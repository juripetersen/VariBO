 ...
 */
 ...
 class Job398v0 extends GeneratableJob {
...
val join3 = filter2.keyBy[Long](_._2).join(group4.keyBy[Long](_._1)).map(x => x.field1)
...
val reduce12 = source14.reduce((x1, x2) => x1)
      

val reduce11 = reduce12.reduce((x1, x2) => x1)
