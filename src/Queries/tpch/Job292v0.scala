 ...
 */
 ...
 class Job292v0 extends GeneratableJob {
...
val join7 = map6.keyBy[Long](_._2).join(source8.keyBy[Long](_._1)).map(x => x.field1)
       

val reduce9 = join7.reduce((x1, x2) => x1)
...
val filter11 = source12.filter(x=>x._3 == 3.0)
      

val join10 = reduce9.keyBy[Long](_._4).join(filter11.keyBy[Long](_._1)).map(x => x.field1)
       

val reduce13 = join10.reduce((x1, x2) => x1)
