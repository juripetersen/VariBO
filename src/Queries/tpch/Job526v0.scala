 ...
 */
 ...
 class Job526v0 extends GeneratableJob {
...
val filter5 = map4.filter(x=>x._4 <= 250.81)
      

val map6 = filter5.map(x=> {var count = 0; for (v <- x.productIterator) count+=1; x})
...
val group7 = map6.reduceByKey(_._1, (t1,t2) => t1)
 ...
 return group7.collectNoExecute()
