 ...
 */
 ...
 class Job969v0 extends GeneratableJob {
...
val group2 = map4.reduceByKey(_._1, (t1,t2) => t1)
...
val join13 = map12.keyBy[Long](_._4).join(source14.keyBy[Long](_._1)).map(x => x.field1)
