 ...
 */
 ...
 class Job114v0 extends GeneratableJob {
...
val partition3 = map2.mapPartitions(x=>x)
      

val sort4 = partition3.sort(_._6)
      

val group5 = sort4.reduceByKey(_._14, (t1,t2) => t1)
...
val filter7 = group8.filter(x=>x._3 <= 5003.0)
      

val join6 = group5.keyBy[Long](_._2).join(filter7.keyBy[Long](_._1)).map(x => x.field1)
