 ...
 */
 ...
 class Job921v0 extends GeneratableJob {
...
val reduce9 = source10.reduce((x1, x2) => x1)
      

val sort8 = reduce9.sort(_._3)
      

val filter7 = sort8.filter(x=>x._6 <= 4541.0650000000005)
