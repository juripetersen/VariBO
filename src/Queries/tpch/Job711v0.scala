 ...
 */
 ...
 class Job711v0 extends GeneratableJob {
...
val group5 = map3.reduceByKey(_._2, (t1,t2) => t1)
...
val join6 = group5.keyBy[Long](_._2).join(source7.keyBy[Long](_._1)).map(x => x.field1)
