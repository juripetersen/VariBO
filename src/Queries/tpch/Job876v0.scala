 ...
 */
 ...
 class Job876v0 extends GeneratableJob {
...
val group3 = map1.reduceByKey(_._2, (t1,t2) => t1)
...
val filter5 = map6.filter(x=>x._4 <= 250.81)
      

val join4 = group3.keyBy[Long](_._2).join(filter5.keyBy[Long](_._1)).map(x => x.field1)
