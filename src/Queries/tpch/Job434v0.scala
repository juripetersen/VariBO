 ...
 */
 ...
 class Job434v0 extends GeneratableJob {
...
val reduce7 = join2.reduce((x1, x2) => x1)
...
val group13 = join8.reduceByKey(_._3, (t1,t2) => t1)
...
val filter15 = source16.filter(x=>x._3 == 1.0)
      

val join14 = group13.keyBy[Long](_._4).join(filter15.keyBy[Long](_._1)).map(x => x.field1)
