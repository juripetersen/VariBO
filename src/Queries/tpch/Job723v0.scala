 ...
 */
 ...
 class Job723v0 extends GeneratableJob {
...
val map8 = group7.map(x=>x).withUdfComplexity(UDFComplexity.LINEAR)
                

val group9 = map8.reduceByKey(_._1, (t1,t2) => t1)
