 ...
 */
 ...
 class Job677v0 extends GeneratableJob {
...
val filter2 = source3.filter(x=>x._4 <= 500.41)
...
val reduce9 = join4.reduce((x1, x2) => x1)
      

val map10 = reduce9.map(x=>x).withUdfComplexity(UDFComplexity.LINEAR)
