 ...
 */
 ...
 class Job440v0 extends GeneratableJob {
...
val group8 = join4.reduceByKey(_._1, (t1,t2) => t1)
...
val filter10 = source11.filter(x=>x._4 == 6.0)
      

val join9 = group8.keyBy[Long](_._2).join(filter10.keyBy[Long](_._1)).map(x => x.field1)
