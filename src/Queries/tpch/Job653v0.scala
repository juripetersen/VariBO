 ...
 */
 ...
 class Job653v0 extends GeneratableJob {
...
val join3 = reduce2.keyBy[Long](_._2).join(map4.keyBy[Long](_._1)).map(x => x.field1)
       

val reduce8 = join3.reduce((x1, x2) => x1)
      

val reduce9 = reduce8.reduce((x1, x2) => x1)
      

 return reduce9.collectNoExecute()
