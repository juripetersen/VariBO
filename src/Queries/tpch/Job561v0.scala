 ...
 */
 ...
 class Job561v0 extends GeneratableJob {
...
val group4 = map6.reduceByKey(_._1, (t1,t2) => t1)
          

val join3 = reduce2.keyBy[Long](_._2).join(group4.keyBy[Long](_._1)).map(x => x.field1)
