 ...
 */
 ...
 class Job337v0 extends GeneratableJob {
...
val filter6 = source7.filter(x=>x._4 <= 500.41)
      

val join5 = filter4.keyBy[Long](_._2).join(filter6.keyBy[Long](_._1)).map(x => x.field1)
