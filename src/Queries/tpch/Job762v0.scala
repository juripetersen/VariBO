 ...
 */
 ...
 class Job762v0 extends GeneratableJob {
...
val join4 = reduce3.keyBy[Long](_._2).join(map5.keyBy[Long](_._1)).map(x => x.field1)
...
val join7 = join4.keyBy[Long](_._2).join(map8.keyBy[Long](_._1)).map(x => x.field1)
