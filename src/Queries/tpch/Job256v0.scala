 ...
 */
 ...
 class Job256v0 extends GeneratableJob {
...
val group4 = map2.reduceByKey(_._1, (t1,t2) => t1)
          

val filter5 = group4.filter(x=>x._11 <= CsvUtils.parseDate("1995-06-19"))
...
val join6 = filter5.keyBy[Long](_._2).join(source7.keyBy[Long](_._1)).map(x => x.field1)
