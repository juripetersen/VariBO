 ...
 */
 ...
 class Job303v0 extends GeneratableJob {
...
val map3 = map4.map(x=>x).withUdfComplexity(UDFComplexity.LINEAR)
...
val join9 = group8.keyBy[Long](_._2).join(group10.keyBy[Long](_._1)).map(x => x.field1)
