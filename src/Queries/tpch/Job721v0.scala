 ...
 */
 ...
 class Job721v0 extends GeneratableJob {
...
val group12 = map13.reduceByKey(_._2, (t1,t2) => t1)
          

val map11 = group12.map(x=>x).withUdfComplexity(UDFComplexity.LINEAR)
                

val join10 = join8.keyBy[Long](_._4).join(map11.keyBy[Long](_._1)).map(x => x.field1)
