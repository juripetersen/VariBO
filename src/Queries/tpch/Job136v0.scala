 ...
 */
 ...
 class Job136v0 extends GeneratableJob {
...
val group6 = map7.reduceByKey(_._3, (t1,t2) => t1)
          

val join5 = join2.keyBy[Long](_._2).join(group6.keyBy[Long](_._1)).map(x => x.field1)
