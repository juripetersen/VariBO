 ...
 */
 ...
 class Job107v0 extends GeneratableJob {
...
val group5 = group6.reduceByKey(_._1, (t1,t2) => t1)
          

val join4 = map3.keyBy[Long](_._2).join(group5.keyBy[Long](_._1)).map(x => x.field1)
       

val filter9 = join4.filter(x=>x._4 <= 250.81)
