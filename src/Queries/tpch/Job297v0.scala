 ...
 */
 ...
 class Job297v0 extends GeneratableJob {
...
val filter4 = filter3.filter(x=>x._11 <= CsvUtils.parseDate("1995-06-19"))
...
val reduce6 = reduce7.reduce((x1, x2) => x1)
      

val join5 = filter4.keyBy[Long](_._2).join(reduce6.keyBy[Long](_._1)).map(x => x.field1)
       

val group10 = join5.reduceByKey(_._1, (t1,t2) => t1)
