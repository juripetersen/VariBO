 ...
 */
 ...
 class Job438v0 extends GeneratableJob {
...
val group4 = sort2.reduceByKey(_._14, (t1,t2) => t1)
...
val group8 = source9.reduceByKey(_._1, (t1,t2) => t1)
...
val join5 = group4.keyBy[Long](_._2).join(map6.keyBy[Long](_._1)).map(x => x.field1)
       

val map10 = join5.map(x=> {var count = 0; for (v1 <- x.productIterator; v2 <- x.productIterator) count+=1; x})
