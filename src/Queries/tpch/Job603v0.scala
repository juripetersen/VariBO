 ...
 */
 ...
 class Job603v0 extends GeneratableJob {
...
val reduce5 = join2.reduce((x1, x2) => x1)
      

val sort6 = reduce5.sort(_._3)
      

val map7 = sort6.map(x=>x).withUdfComplexity(UDFComplexity.LINEAR)
