 ...
 */
 ...
 class Job273v0 extends GeneratableJob {
...
val filter2 = filter1.filter(x=>x._5 <= 13.0)
      

val filter3 = filter2.filter(x=>x._11 <= CsvUtils.parseDate("1995-06-19"))
      

val filter4 = filter3.filter(x=>x._15 ==  "AIR" )
...
val join5 = filter4.keyBy[Long](_._2).join(map6.keyBy[Long](_._1)).map(x => x.field1)
